...
"}")
        ...
        self.radioButtonsGroup_3.setGeometry(QRect(400, 410, 191, 281))
        ...
        self.horizontalSlider.setGeometry(QRect(10, 250, 161, 21))
...
"")
        ...
        self.label = QLabel(self.radioButtonsGroup_3)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(40, 230, 31, 16))
        self.horizontalScrollBar = QScrollBar(self.radioButtonsGroup_3)
        self.horizontalScrollBar.setObjectName(u"horizontalScrollBar")
        self.horizontalScrollBar.setGeometry(QRect(20, 200, 160, 16))
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"23", None))
