...
# from poser.AlphaPose.utils.bbox import _box_to_center_scale, _center_scale_to_box
# from poser.AlphaPose.utils.transforms import get_affine_transform, im_to_torch
