...
class FeatureBuilder(object):
	...
	def build_feature(self, ret, img_name, is_camera=False):
		...
		:return:
			meta: cname, xyxy, ctid
			features: [num_obj, h, w*c, 3], wh是配置文件制定的特征宽和高，c是连续帧数目
		"""
		if ret is None:
			return None, None
		# 给数据
		# print('build feature', ret.shape)
		...
		for i, d in enumerate(c_data):
			...
			for j in reversed(range(c-1)):  # 3 2 1 0
